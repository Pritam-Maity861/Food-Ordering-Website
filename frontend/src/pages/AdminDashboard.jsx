...
const AdminDashboard = () => {
    ...
    const sidebarLinks = [
        { name: "Dashboard", path: "dashboard", component: AdminDashboardContent },
        { name: "Restaurants", path: "restaurants", component: RestaurantsContent },
        { name: "Users", path: "users", component: UsersContent },
    ];
    ...
    const CurrentComponent = currentSection ? currentSection.component : AdminDashboardContent;
