...
const ContactUs = () => {
  return (
    <div className='pt-30 pb-30 border-t border-gray-300 shadow-2xl bg-gray-100'
    id='contact'
    >
      <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                Or just reach out manually to us at <a href="#" className="text-indigo-600 hover:underline">maitypritam861@gmail.com</a>
            </p>
